...
| Outbound private-address HTTP destinations | Closed | `OutboundUrlGuard` on SNS HTTP(S), API Gateway HTTP proxy integrations, and ALB IP or hostname targets (`OutboundUrlGuardTest`, `HttpProxyInvokerTest`) |
