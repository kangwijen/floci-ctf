...
public class FirehoseService {
    ...
    public String createDeliveryStream(String name, S3Destination s3Config, List<DeliveryStreamDescription.Tag> tags) {
        return createDeliveryStream(name, null, s3Config, tags, null);
    }
    ...
    public String createDeliveryStream(String name, String roleArn, S3Destination s3Config,
        ...
        return createDeliveryStream(name, roleArn, s3Config, tags, null);
    }

    public String createDeliveryStream(String name, S3Destination s3Config, List<DeliveryStreamDescription.Tag> tags,
                                       String deliveryStreamType) {
        return createDeliveryStream(name, null, s3Config, tags, deliveryStreamType);
    }
