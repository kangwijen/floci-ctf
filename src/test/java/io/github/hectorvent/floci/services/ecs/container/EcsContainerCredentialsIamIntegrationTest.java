...
/**
 * End-to-end: ECS container credentials issue ASIA keys that honor the task role IAM policy.
 */
@QuarkusTest
@TestProfile(LambdaContainerCredentialsIamProfile.class)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class EcsContainerCredentialsIamIntegrationTest {

    private static final String ACCOUNT = "000000000000";
    private static final String REGION = "us-east-1";
    private static final String ROLE_NAME = "EcsContainerCredS3Role";
    private static final String ROLE_ARN = "arn:aws:iam::" + ACCOUNT + ":role/" + ROLE_NAME;
    private static final String ALLOWED_BUCKET = "ecs-cred-allowed";
    private static final String DENIED_BUCKET = "ecs-cred-denied";
    private static final String ALLOWED_KEY = "object-allowed.txt";
    private static final String DENIED_KEY = "object-other.txt";
    private static final String TASK_ID = "ecs-cred-iam-task";
    ...
    void provision() throws Exception {
        ...
        credsPort = config.services().ecs().containerCredentialsPort();
        ...
        String taskArn = "arn:aws:ecs:" + REGION + ":" + ACCOUNT + ":task/default/" + TASK_ID;
        credentialToken = credentialsServer.registerTask(
                taskArn, TASK_ID, ROLE_ARN, "ecs-cred-family", REGION);
    }
